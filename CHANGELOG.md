...
- filtrage des pays via geoloc en liste autorisée ou non autorisée
- Redis (en option) pour le stockage des données de session (geoloc, etc)
- Filtrage antibot pour les bots IA (ChatGPT, Bard, etc)
